...
def get_total_wins(intent, session):
    pass

def get_total_games(intent, session):
    pass
...
def on_intent(intent_request, session):
    ...
    elif intent_name == "GetTotalStats":
        return get_stats(intent, session)
    elif intent_name == "GetRecentGame":
        return get_recent_game(intent, session)
    elif intent_name == "GetTotalWins":
        return get_total_wins(intent, session)
    elif intent_name == "GetTotalGames":
        return get_total_games(intent, session)
    else:
